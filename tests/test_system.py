...
from fiabilipym import Component, Voter, System
...
class TestComponent(unittest.TestCase):
    ...
    def test_maintainability(self):
        ...
        expected = 1 - exp(-self.mu * self.t)
        actual = self.component.maintainability(self.t)
        self.assertTrue(simplify(expected - actual) == 0)
...
class TestSystem(unittest.TestCase):
    ...
    def test_graphmanagement(self):
        ...
        system[component[0]] = 'S'
        wanted = DiGraph({'E':[component[0], component[1]], component[0]:['S']})
